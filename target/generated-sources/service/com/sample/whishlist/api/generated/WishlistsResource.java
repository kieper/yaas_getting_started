...
public interface WishlistsResource
{
	...
	Response get(@javax.ws.rs.BeanParam @javax.validation.Valid final PagedParameters paged);

	@javax.ws.rs.POST
	@javax.ws.rs.Consumes({"application/json"})
	Response post(@javax.ws.rs.BeanParam @javax.validation.Valid final PagedParameters paged, @javax.validation.Valid final Wishlist wishlist);
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Produces({"application/json"})
	Response getByWishlistIdWishlistItems(@javax.ws.rs.BeanParam @javax.validation.Valid final PagedParameters paged, @javax.ws.rs.PathParam("wishlistId") final java.lang.String wishlistId);

	@javax.ws.rs.Path("/{wishlistId}/wishlistItems")
	@javax.ws.rs.POST
	@javax.ws.rs.Consumes({"application/json"})
	@javax.ws.rs.Produces({"application/json"})
	Response postByWishlistIdWishlistItems(@javax.ws.rs.BeanParam @javax.validation.Valid final PagedParameters paged, @javax.ws.rs.PathParam("wishlistId") final java.lang.String wishlistId, @javax.validation.Valid final WishlistItem wishlistItem);
